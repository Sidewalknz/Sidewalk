  ...
  const html = `
    ...
    <head>
      <style>
        ...
        .summary-4 { display: grid; grid-template-cols: repeat(4, 1fr); gap: 15px; margin-bottom: 40px; }
    ...
    <body>
      ...
      ${report.lighthouse ? `
        <h2 style="margin-top: 0; margin-bottom: 15px;">Lighthouse Metrics</h2>
        <div class="summary-4">
          <div class="card">
            <div class="score" style="font-size: 24px; color: ${report.lighthouse.performance >= 90 ? '#22c55e' : report.lighthouse.performance >= 50 ? '#D7B350' : '#B74831'}">${report.lighthouse.performance}</div>
            <div class="label">Performance</div>
          </div>
          <div class="card">
            <div class="score" style="font-size: 24px; color: ${report.lighthouse.accessibility >= 90 ? '#22c55e' : report.lighthouse.accessibility >= 50 ? '#D7B350' : '#B74831'}">${report.lighthouse.accessibility}</div>
            <div class="label">Accessibility</div>
          </div>
          <div class="card">
            <div class="score" style="font-size: 24px; color: ${report.lighthouse.bestPractices >= 90 ? '#22c55e' : report.lighthouse.bestPractices >= 50 ? '#D7B350' : '#B74831'}">${report.lighthouse.bestPractices}</div>
            <div class="label">Best Practices</div>
          </div>
          <div class="card">
            <div class="score" style="font-size: 24px; color: ${report.lighthouse.seo >= 90 ? '#22c55e' : report.lighthouse.seo >= 50 ? '#D7B350' : '#B74831'}">${report.lighthouse.seo}</div>
