...
export const metadata = {
  ...
  description:
    'Terms of service for Sidewalk, a Nelson web agency offering web design, website design, and web development services.',
}
  ...
  const sections = [
    {
      ...
      content:
        'By using this website, you agree to use it for lawful purposes and in a way that does not interfere with the website, its security, or other people using it. Website content is provided for general information about Sidewalk and our services and is not a binding quote or formal project agreement.',
    },
    {
      title: 'Enquiries and project work',
      content:
        'Submitting an enquiry does not create a client relationship or require either party to proceed with a project. Any project scope, deliverables, timing, fees, payment terms, hosting, maintenance, ownership, and support arrangements will be confirmed separately in writing before work begins.',
    },
    {
    ...
    },
    {
      ...
      content:
        'This website may link to third-party websites, tools, or services. Those third parties are responsible for their own content, terms, privacy practices, availability, and security. We are not responsible for loss or damage caused by third-party websites or services.',
    },
    {
      title: 'Liability and New Zealand consumer law',
      content:
        'Nothing in these terms limits any rights you may have under New Zealand law, including the Consumer Guarantees Act 1993 and Fair Trading Act 1986 where they apply. To the extent permitted by law, Sidewalk is not liable for indirect, consequential, or special loss arising from use of this website or reliance on its general content.',
    },
    {
      title: 'Governing law',
      content:
          ...
          <Reveal className="lg:col-span-4">
            <div className="lg:sticky lg:top-28">
              ...
              <p className="mt-6 text-lg leading-8 text-[#1C2830]/75">
                These terms cover use of this website. Project-specific terms are agreed separately
                before client work begins.
              </p>
            </div>
          </Reveal>
