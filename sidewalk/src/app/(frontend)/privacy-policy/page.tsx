...
export const metadata = {
  ...
  description:
    'Privacy policy for Sidewalk, a Nelson NZ web agency providing web design, website design, and web development services.',
}
...
export default function PrivacyPolicyPage() {
  const sections = [
    ...
    },
    {
      ...
      content:
        'We do not sell personal information. We may share information with trusted service providers where needed to operate this website, manage enquiries, host websites, send email, analyse website performance, process payments, or deliver project work. Some providers may store or process information outside New Zealand. Where that happens, we take reasonable steps to use providers with appropriate privacy and security protections.',
    },
    {
      title: 'Cookies and analytics',
      content:
        'This website may use cookies, analytics, server logs, and similar technologies to understand how visitors use the site and to keep it secure. You can usually disable or limit cookies through your browser settings, although some website functions may not work as expected.',
    },
    {
      title: 'Access, correction, and privacy breaches',
      content:
        'Under the New Zealand Privacy Act 2020, you can ask to access or correct personal information we hold about you. If we become aware of a privacy breach that has caused serious harm or is likely to do so, we will notify the Office of the Privacy Commissioner and affected people where required by law.',
    },
  ]
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-4 sm:px-6 lg:grid-cols-12 lg:gap-16 lg:px-8">
          <Reveal className="lg:col-span-4">
            <div className="lg:sticky lg:top-28">
              ...
              <p className="mt-6 text-lg leading-8 text-[#1C2830]/75">
                This page explains what personal information this website may collect, how Sidewalk
                uses it, and your rights under New Zealand privacy law.
              </p>
            </div>
          </Reveal>
          ...
          <div className="divide-y divide-[#1C2830]/20 lg:col-span-8">
            {sections.map((section, index) => (
              <Reveal key={section.title} delay={100 + index * 75} className="py-8 first:pt-0">
                <h2 className="text-3xl font-extrabold leading-tight text-[#B74831]">
                  {section.title}
                </h2>
                <p className="mt-4 text-lg leading-8 text-[#1C2830]/80">{section.content}</p>
              </Reveal>
            ))}

            <Reveal delay={200} className="border-t border-[#1C2830]/20 pt-8">
